...
export const redPin = require("../assets/icons/redPin.png");
export const riceBowl = require("../assets/icons/riceBowl.png");
export const salad = require("../assets/icons/salad.png");
export const search = require("../assets/icons/search.png");
export const shoppingBasket = require("../assets/icons/shoppinBasket.png");
